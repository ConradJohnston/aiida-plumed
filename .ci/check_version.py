...
Check version number in setup.json and aiida_plumed/__init__.py and make sure
they match.
"""
...
import aiida_plumed  # pylint: disable=wrong-import-position
version = aiida_plumed.__version__
