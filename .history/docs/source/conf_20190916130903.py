# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-plumed
#
...
release = aiida_plumed.__version__
...
html_use_opensearch = 'http://aiida-plumed.readthedocs.io'
...
htmlhelp_basename = 'aiida-plumed-doc'
